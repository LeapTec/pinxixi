...
<body style="overflow: hidden;">
	...
	<div style="padding: 15px 10px 0px 10px;">
		<form class="layui-form" action="BackBrandUpdate" method="post" style="text-align: center;">
			<input type="hidden" name="BID" value="${requestScope.b.BID }" />
      		<input type="text" name="BName" value="${requestScope.b.BName }" required  lay-verify="required"
      		 placeholder="请填写品牌名" autocomplete="off" class="layui-input" style="margin-bottom: 10px;">
