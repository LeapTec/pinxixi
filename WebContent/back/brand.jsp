...
<%-- 引入页面所需css --%>
<link href="../css/back-brand.css" rel="stylesheet">
			...
			<div class="layui-row layui-col-space15">
				<div class="layui-col-xs12">
					...
					<div class="layui-card">
						<div class="layui-card-header">添加品牌</div>
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<button class="layui-btn" type="button" id="addbrand">添加品牌</button>
							</div>
						</div>
					</div>
					<%-- 搜索框 --%>
					<div class="layui-card">
						<div class="layui-card-header">品牌查询</div>
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<form class="layui-form" action="BackBrand" method="post">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<table lay-filter="table">
									<thead>
										<tr>
											<th lay-data="{field : 'BID',title : '#',sort : true,type : 'numbers',fixed : 'left'}"></th>
											<th lay-data="{field:'BID',width:50,type:'checkbox',fixed : 'left'}"></th>
					...
					<div class="layui-card">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<form class="layui-form" action="BackBrandDel" method="post" id="batchSelect">
...
<!-- 	<script src="../others/bootstrap/bootstrap.min.js"></script> -->
	...
	<script src="../js/back-brand.js"></script>
