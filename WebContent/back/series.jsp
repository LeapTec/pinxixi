...
<%-- 引入页面所需css --%>
<link href="../css/back-series.css" rel="stylesheet">
			...
			<div class="layui-row layui-col-space15">
				<div class="layui-col-xs12">
					...
					<div class="layui-card">
						<div class="layui-card-header">添加系列</div>
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<button class="layui-btn" type="button" id="addseries">添加系列</button>
							</div>
						</div>
					</div>
					<%-- 搜索框 --%>
					<div class="layui-card">
						<div class="layui-card-header">系列查询</div>
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<form class="layui-form" action="BackSeries" method="post">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<table lay-filter="table">
									<thead>
										<tr>
											<th lay-data="{field : 'SID',title : '#',sort : true,type : 'numbers',fixed : 'left'}"></th>
											<th lay-data="{field:'SID',width:50,type:'checkbox',fixed : 'left'}"></th>
											<th lay-data="{field:'BName',sort : true,title:'品牌名'}"></th>
											<th lay-data="{field:'SName',sort : true,title:'系列名'}"></th>
					...
					<div class="layui-card">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<form class="layui-form" action="BackSeriesDel" method="post" id="batchSelect">
...
<!-- 	<script src="../others/bootstrap/bootstrap.min.js"></script> -->
	...
	<script src="../js/back-series.js"></script>
