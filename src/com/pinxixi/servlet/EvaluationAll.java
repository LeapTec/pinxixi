...
/**
 * Servlet implementation class EvaluationAll
 */
@WebServlet("/EvaluationAll")
public class EvaluationAll extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Evaluation> list = evad.SelectEvaluationAll("");
